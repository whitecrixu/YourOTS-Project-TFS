...
void printServerVersion()
{
	...
	startupMsg << hrLine;
	startupMsg << "- " << "A server developed by " << console::setColor(console::developers, STATUS_SERVER_DEVELOPERS) << " (" << console::setColor(console::community, "https://discord.gg/OTAcademy") << ")" << std::endl;
	startupMsg << "- " << "Visit our community for updates, support and resources." << std::endl;
	startupMsg << hrLine;
